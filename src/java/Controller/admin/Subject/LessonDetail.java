 ...
 * @author Louis
 */
@WebServlet(name = "LessonDetail", urlPatterns = {"/admin/LessonDetail"})
public class LessonDetail extends AdminHomeController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("action") == "edit" && request.getParameter("lid") != null && request.getParameter("cid") != null) {
            int lid = Integer.parseInt(request.getParameter("lid"));
            int tid = Integer.parseInt(request.getParameter("tid"));
            Lesson lesson = LDAO.GetALessonByID(lid);
