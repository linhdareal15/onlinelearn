 ...
 * @author Century
 */
public class AddSliderController extends AdminHomeController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String title_value = "Add Slider";
        request.setAttribute("title_value", title_value);
        request.setAttribute("pageInclude", "../admin/addSlider.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sd.insertSlider(title, image, backlink, status, note);
