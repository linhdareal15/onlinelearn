 ...
 * @author Century
 */
public class EditSliderController extends AdminHomeController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("s", s.GetSliderByID(id));
        String title_value = "Edit Slider";
        request.setAttribute("title_value", title_value);
        request.setAttribute("pageInclude", "../admin/editSlider.jsp");
