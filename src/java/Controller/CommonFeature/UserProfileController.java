...
public class UserProfileController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            int temp = Integer.parseInt(request.getParameter("gender"));
            Part filePart = request.getPart("avatar"); 
            
            InputStream fileContent = filePart.getInputStream();
            Boolean gender = temp == 1? true:false;
            UserDBContext dao= new UserDBContext();
            int check = dao.updateProfileUser(id, username, fullname,  gender, address,  phone,  null);
            if(check!=0){
                response.sendRedirect("client/login?id="+id+"&action=xvyz");
            }
    }
