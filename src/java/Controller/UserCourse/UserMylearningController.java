 ...
 * @author Quang
 */
@WebServlet(name = "UserMylearningController", urlPatterns = {"/mylearning"})
public class UserMylearningController extends Home {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("pageInclude", "../client/userCourseList.jsp");
