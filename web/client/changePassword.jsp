    ...
    <body>
            ...
            <div class="wrapper">
                ...
                <form action="changepass" method="POST">
                    <div class="row eye">
                        ...
                        <input id="pass" name="oldpassword" type="password" placeholder="Enter current password" required>
                        <img onclick="myfunction()" src="client/img/eye.png" style="display: inline-block">
                    </div>
                    <div class="row eye">
                        <i class="fas fa-lock"></i>
        ...
        <script type="text/javascript">
            ...
            function send() {
                ...
                var oldpass = arr[0].value;
                var newpass = arr[1].value;
                var repass = arr[2].value;
                if (!oldpass.match(patternPassWord)) {
                    return;
                }
