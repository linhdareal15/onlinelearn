<%-- 
    ...
    Created on : Jan 16, 2022, 11:42:01 AM
    Author     : Duy Hiep
--%>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">We're excited to have you get started to send a form reset your password to your email. First, you need to confirm and fill into your email</p>
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                    <div 
                                                        ...
                                                        Enter your email:  <input type="text" name="email" ><button type="submit">SEND</button>
                                                    </div>
                                                    <p  style="color: #cc0033">${messager}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
